...
public class Constants {
    public static final String discordToken = "NDgzNzk5NTIzMjY1ODcxODky.Dnm-Vw.v26bXFAua8Jr7cNU-KHa0Di2Ibg"; /*Insert Your Own Discord Token*/
    ...
    public static final String rebirth = "https://www.reddit.com/r/IdlePoring/comments/73yxb5/rebirth_explained/\nhttps://docs.google.com/spreadsheets/d/1XqSTWDmZokJKloo9w9Ip3GufavDew-D6E2jiykf5ZdA/edit#gid=0\nRegarding which MVP should we get? It's complicated, to explain, so just go ahed and ask <@timlo#8485> ";
    ...
    public static final String MagicalShock = "```Magical Shock / Fatal Blow / Power Arrow```";
    public static final String MagicalDouble = "```Magical Double Hit / Multiple Attack / Double Strafe```";
    public static final String StoneCurse = "```Stone Curse / Frost Blade / Frost Bolt```";
    public static final String Sleep = "```Sleep / Sleeping Blade / Sleep Bolt```";
    public static final String Silence = "```Silence / Blade of Silence / Silence Bolt```";
    public static final String ElementFocus = "```Element Focus / Spear Dynamo / Meditation```";
    public static final String Dexterity = "```Dexterity / Dexterity / Wind Walker```";
    public static final String MentalPower = "```Mental Power / Triple Action / Triple Strafe```";
    public static final String CurseMagic = "```Curse Magic / Cursed Blade / Cursed Bolt```";
    public static final String EnergyReflection = "```Energy Reflection / Furious Blow / Furry Arrow```";
    public static final String ElementBomb = "```Element Bomb / Charged Attack / Aimed Bolt```";
    public static final String ThunderousShot = "```Thunderous Shot / Vital Strike / Falcon Eyes```";
    public static final String FireWall = "```Fire Wall / Pierce / Ghost Arrow```";
    public static final String MagicalChase = "```Magical Chase / Traumatic Blow / Vulnerability Mark```";
    public static final String EnergyTransfer = "```Energy Transfer / Blade of Blood / Blood Steal```";
    ...
    public static final String petSkillHelp = "```Apache\n" +
            ...
            "pSkill AS    : Attack Strengthen\n" +
            "pSkill AT    : Attack Terminator\n" +
            "pSkill AW    : Awaken\n" +
            "pSkill BS    : Bloodshot\n" +
            "pSkill CC    : Concentration\n" +
            "pSkill CE    : Controlled Enhance\n" +
            "pSkill CA    : Counter Attack\n" +
            "pSkill CU    : Cure\n" +
            "pSkill DS    : DMG Share\n" +
            "pSkill ED    : Element Delay\n" +
            "pSkill FA    : Fanatic\n" +
            "pSkill FI    : Firmness\n" +
            "pSkill FU    : Follow-up\n" +
            "pSkill FD    : Frost Diver\n" +
            "pSkill GAS   : Group Assassination\n" +
            "pSkill GAW   : Group Awaken\n" +
            "pSkill GC    : Group Counter\n" +
            "pSkill GF    : Group Freeze\n" +
            "pSkill GR    : Group Restore\n" +
            "pSkill GSL   : Group Sleep\n" +
            "pSkill GSO   : Group Stone\n" +
            "pSkill GSR   : Group Strengthen\n" +
            "pSkill GSU   : Group Stun\n" +
            "pSkill LS    : Life Stealer\n" +
            "pSkill LT    : Life Transfer\n" +
            "pSkill MB    : Magic Burn\n" +
            "pSkill MR    : Marker\n" +
            "pSkill MA    : Multiple Attack\n" +
            "pSkill PR    : Protection\n" +
            "pSkill QS    : Quick Spell\n" +
            "pSkill RA    : Raid Away\n" +
            "pSkill RE    : Restore\n" +
            "pSkill ST    : Shield of Tardy\n" +
            "pSkill SL    : Sleep\n" +
            "pSkill SA    : Sleep Attack\n" +
            "pSkill SN    : Sneer\n" +
            "pSkill SD    : Soul Destroyer\n" +
            "pSkill SCO   : Spirit Counter\n" +
            "pSkill SCU   : Stone Curse\n" +
            "pSkill SR    : Strengthen\n" +
            "pSkill SW    : Swift\n" +
            "pSkill TH    : Thump\n" +
            "pSkill UN    : Unyield\n" +
            "pSkill WT    : Weak Track```";
    ...
    public static final String pskillDS = "```md\n<Skill: Damage Share>\n" +
            "<Effect: Split DMG taken when an ally>\n\n" +
    ...
    public static final String pskillWT = "```md\n<Skill: Weak Track>\n" +
            "<Effect: Enemy is stunned if attacked enough (Level 4 is AOE, and can be used to cut Guardian support skill)>\n\n" +
    ...
    public static final String runeAd = "```md\n<Rune: Adamzat>\n" +
            "<Effect: Attacks do extra DMG based on your HP difference from your enemy.(Level 1 +10% DMG of HP difference, Level 2 +12.5% DMG of HP difference, Level 3 +15% DMG of HP difference;Capped at 50% difference)>\n\n" +
    ...
    public static final String runeHa = "```md\n<Rune: Haere>\n" +
            "<Effect: DMG beyond certain amount becomes 1>\n\n" +
            "Unlock 1: Treasure Map\n" +
    ...
    public static final String runeTa = "```md\n<Rune: Taika>\n" +
            "<Effect: Skill cannot be cancelled>\n\n" +
    ...
    public static final String addME = "Add me at https://discordapp.com/api/oauth2/authorize?client_id=387846932334379008&permissions=0&scope=bot";
}
