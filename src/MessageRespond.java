        ...
        try {
            ...
            if (!event.isFromType(ChannelType.PRIVATE) && message.startsWith("p!")) {
                ...
                if (message.startsWith("p!help")) {
                    event.getTextChannel().sendMessage("All of the commands Ma Copine has. Ma Copine is case insensitive.").queue((message2 -> message2.delete().queueAfter(120, TimeUnit.SECONDS,onSuccess -> {}, Throwable::printStackTrace)));
                    ...
                    event.getTextChannel().sendMessage("").queue((message2 -> message2.delete().queueAfter(30, TimeUnit.SECONDS)));
                    counter++;
                }
